                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table">
                            ...
                            <?php $postlink_data = old("postlink", [["name"=>"", "url"=>""]]) ?>
                ...
                <div class="box">
                    ...
                    <div class="box-body no-padding">
                        <table class="table">
                            ...
                            <?php $postmeta_data = old("postmeta", [["key"=>"", "value"=>""]]) ?>
                            @foreach ($postmeta_data as $key => $meta)
                                <tr class="postmeta-item">
                                    <td><input type="text" name="postmeta[{{ $key }}][key]" class="form-control postmeta-key" value="{{ $meta['key'] }}"></td>
                                    <td><input type="text" name="postmeta[{{ $key }}][value]" class="form-control postmeta-value" value="{{ $meta['value'] }}"></td>
            ...
            var updateSlug = function () {
                if (autoSlug) {
                    $.ajax({
                        ...
                        method: "post",
                        data: { msg: $("#input-title").val(), module: {!! json_encode(\App\Post::class) !!} }
                    }).done(function (data) {
                        $("#slug").val(data);
                    });
                }
